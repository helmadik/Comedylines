import re
# TODO:
# change the way that the user can enter the play (as a string?)
# more protection/checks to make sure the input is valid
# figure out how to transfer it/make it public!
